...
<!-- Does this mean that the covariates of the two treatment groups should look the same? Are there any ways to assess for confoudedness other than looking at how treatment is assigned? -->
...
<!-- In my response, I focused on the role of courage in making conclusions from the analysis and being transparent about limitations and questions from others. The answer here seems like it applies to earlier stages in the analysis: developing the data generating mechanism, using math and exploring the data set. Does courage also apply to later steps? I think I need some help fully understanding this... but maybe (as said in the tutorial, I just need to be patient). Am I confusing temperance with courage? -->
...
<!-- Why does the Preceptor Table refer to only a single time point? Aren't there data from different times - like the outcome in this example occurs in the future. -->
...
<!-- Just to clarify, does the Preceptor Table only include relevant covariates? Does this need to be fully determined before? Is it a judgement call or done empirically? -->
...
<!-- Can this be assessed via covariates that might indicate smartness? Which variables would not be the same in this example? -->
...
<!-- Would attending college be an important covariate / outcome to include? -->
